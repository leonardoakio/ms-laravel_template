...
2. ross-slot Operations: Avoid operations that involve multiple keys that may reside on different shards because they're not natively supported.
...
3. Understand your read/write loads
...
## Conclusion
Redis is an indispensable tool in the modern software stack. Harnessing its full potential, however, requires a sound understanding of its capabilities and appropriate application. To implement these best practices efficiently, a variety of tools like [**Redis CLI**](https://redis.io/docs/connect/cli/), [**RedisInsight**](https://redis.com/redis-enterprise/redis-insight/), [**Redmon**](https://github.com/steelThread/redmon), and [**Prometheus with Grafana**](https://prometheus.io/docs/visualization/grafana/) can be extremely helpful. Meanwhile, resources such as the [**Redis Official Documentation**](https://redis.io/docs/), [**Redis University**](https://university.redis.com/), [**Redis Labs Blog**](https://redis.com/blog/), and the [**StackOverflow #Redis Thread**](https://stackoverflow.com/questions/tagged/redis) are invaluable for further learning. With these tools and resources at your disposal, you'll be well-equipped to design scalable, flexible, and efficient Redis implementations.
...
[**- Dragonfly**](https://www.dragonflydb.io/guides/redis-best-practices)